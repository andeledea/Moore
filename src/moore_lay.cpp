...
PosFrame::PosFrame( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : wxFrame( parent, id, title, pos, size, style, name )
{
	...
	Pos_set_tool = pos_toolbar->AddTool( wxID_ANY, wxT("Settings"), wxBitmap( wxT("C:/Users/Andrea/Documents/Moore/Moore/icons/set.bmp"), wxBITMAP_TYPE_ANY ), wxNullBitmap, wxITEM_NORMAL, wxEmptyString, wxEmptyString, NULL );
